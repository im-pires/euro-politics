...
def update_pie_chart(country_name):
    ...
    # scatter itself
    country_party = parties.loc[parties['country_name'] == country_name]
    fig = px.bar(country_party, x="seats", y="family_name", color='party_name_short',
								 color_discrete_sequence=px.colors.qualitative.Prism, orientation='h',
                 labels={
                     "seats": "Seats in Parliament",
                     "family_name": "Political Orientation"
                 }
                 )

    # fig.update_traces(textposition='top center')

    fig.update_layout(title_text="Political Orientation Importance")
    ...
    fig.update_layout(
        ...
        legend_title_text='Political Parties',
